    ...
    if (carteGirate.length === 2) {
      ...
      if (img1.src === img2.src) {
        ...
        setTimeout(() => {
          ...
          img1.src =
            "https://static.vecteezy.com/ti/vettori-gratis/p3/6941674-foresta-con-pini-logo-icona-simbolo-illustrazione-design-silhouette-vettoriale.jpg";
          img2.src =
            "https://static.vecteezy.com/ti/vettori-gratis/p3/6941674-foresta-con-pini-logo-icona-simbolo-illustrazione-design-silhouette-vettoriale.jpg";
          carteGirate = [];
          errori++;
...
let aggiornaErrori = () => {
  ...
  if(errori === 10){
    alert("Hai commesso troppi errori! Riprova, puoi farcela!");
  }
};
...
reset.addEventListener("click", () => {
  ...
  for(let i = 1; i <= 12 ; i++){
    ...
    img.src = "https://static.vecteezy.com/ti/vettori-gratis/p3/6941674-foresta-con-pini-logo-icona-simbolo-illustrazione-design-silhouette-vettoriale.jpg";
  }
...
fetch("/giocomemory/avanzato/file.json")
